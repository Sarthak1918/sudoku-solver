...
var SudokuSolver = function (testable) {
  ...
  function getColumn(boardArray, i) {
    ...
    return [0, 1, 2, 3, 4, 5, 6, 7, 8].map(function (num) {
      return boardArray[startingEl + num * 9];    //adding 9 to each cell to get the row of the columns
    });
  }
  ...
  function collectionIsValid(collection) {   //to check wheather there is any dupliate data
    var numCounts = {};
